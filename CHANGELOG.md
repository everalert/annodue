...
- Overlay: Detailed speed readout, with raw readout option
- Overlay: Terrain speed readout
- Overlay: Simplified FPS readout option
- Overlay: MFG (bounce glitch) timer
