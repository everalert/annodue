...
// TODO: implement swe1r-patcher function
export fn DumpTexture() void {}

// TODO: implement swe1r-patcher function
export fn DumpTextureTable() void {}

// TODO: implement swe1r-patcher function
export fn PatchTextureTable() void {}
...
// WARNING: not tested
export fn ModifyNetworkGuid(data: [*]u8, size: usize) void {
    // RC4 hash
    const state = struct {
...
// WARNING: not tested
export fn PatchNetworkUpgrades(memory_offset: usize, upgrade_levels: *[7]u8, upgrade_healths: *[7]u8) usize {
    if (USE_PATCHED_GUID) {
...
// WARNING: not tested
export fn PatchNetworkCollisions(memory_offset: usize) usize {
...
// WARNING: not tested
export fn PatchAudioStreamQuality(memory_offset: usize, sample_rate: u32, bits_per_sample: u8, stereo: bool) usize {
    var offset: usize = memory_offset;
...
// WARNING: not tested
export fn PatchSpriteLoaderToLoadTga(memory_offset: usize) usize {
